...
`,
			...
			*/
			Flags: []cli.Flag{
				...
				cli.BoolFlag{
					Name:  "c_ec",
					Usage: "Use contigeous layout erasure coding",
				},
				cli.BoolFlag{
					Name:  "s_ec",
				...
				cli.IntFlag{
					...
					Value: defaultAddParams.O,
				},
				cli.IntFlag{
					Name:  "par",
					Usage: "used to set the parity chunks number when using erasure coding",
					Value: defaultAddParams.P,
				},
			},
			Action: func(c *cli.Context) error {
				shard := c.Bool("shard")
