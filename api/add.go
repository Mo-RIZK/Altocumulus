...
func AddParamsFromQuery(query url.Values) (AddParams, error) {
	...
	err = parseIntParam(query, "or", &params.O)
	if err != nil {
		return params, err
	}
	err = parseIntParam(query, "par", &params.P)
	if err != nil {
		return params, err
	}
	...
	err = parseBoolParam(query, "c_ec", &params.Cec)
	if err != nil {
		return params, err
	}
	err = parseBoolParam(query, "s_ec", &params.Sec)
	if err != nil {
		return params, err
	}
